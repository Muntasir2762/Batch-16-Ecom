...
<body>
    <div style="display: flex;align-items: center;justify-content: space-between;margin-bottom: 25px">
        <div style="width: 35%">
            <img src="{{asset('backend/images/settings/'.$siteSettings->logo)}}" style="max-height: 100px; width: 100px;" alt="logo" />
        </div>
        <div style="width: 65%">
    ...
    <div style="display: flex;justify-content: space-between;">
        ...
        <div style="width: 33.33%;margin-right: 40px;">
            ...
            <p style="font-size: 18px;font-family: 'Open Sans', sans-serif;color: #000;font-weight: 600;margin-bottom: 0;">
                Ecommerce.com<br>For any query call: {{$siteSettings->phone}}<br>{{$siteSettings->address}}
            </p>
        </div>
