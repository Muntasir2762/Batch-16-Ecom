                    ...
                    <div class="footer__item-wrap">
                        ...
                        <ul class="footer__social-list">
                            <li class="footer__social-list-item">
                                <a href="{{$siteSettings->facebook}}" target="_blank" class="footer__social-list-item-lisk">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            </li>
                            <li class="footer__social-list-item">
                                <a href="{{$siteSettings->twitter}}" target="_blank" class="footer__social-list-item-lisk">
                                    <i class="fab fa-twitter"></i>
                                </a>
                            </li>
                            <li class="footer__social-list-item">
                                <a href="{{$siteSettings->instagram}}" target="_blank" class="footer__social-list-item-lisk">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                            <li class="footer__social-list-item">
                                <a href="{{$siteSettings->youtube}}" target="_blank" class="footer__social-list-item-lisk">
